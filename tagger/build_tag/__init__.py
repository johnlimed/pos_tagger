...
def __count_bi_word(training_file):
    total_word_count, count_previous_t_against_t, count_tag_against_word, count_word_against_tag = 0, {}, {}, {}
    count_tag = {}
    ...
    return count_tag_against_word, count_word_against_tag, count_previous_t_against_t, count_tag
